...
public class Location
{
    ...
    /// </summary>
    public List<string>? RestrictionIds { get; set; } = new();

    /// <summary>
    /// List of Accessibility Feature IDs associated with the Location.
    /// </summary>
    public List<string>? AccessibilityFeatureIds { get; set; } = new();

    /// <summary>
    /// Dictionary indicating the suitability of the Location for various purposes.
    /// </summary>
    public Dictionary<string, bool>? Suitabilities { get; set; } = new();
